 ...
 * @returns {Promise<{ userLanguageObject: object, activeTopicsTitles: { id: string, title: string, activationDate: string }[] }>} A promise that resolves to an object containing
