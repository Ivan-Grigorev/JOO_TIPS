...
var1_2_2 = [4, 5, 6]
var1_2_3 = [7, 8, 9]
var1_2_4 = [var1_2_1, var1_2_2, var1_2_3]
var2_1 = ["d", "e", "f"]
var2_2 = [1, 2, 3, 4, 5, 6, 7, 8, 9]
var3_1 = ["+", "*"]
var4_1 = ["k", "l", "m"]
var3 = ["'", ""]
var3_2 = ["'", ""]
...
try:
    ...
    var_r = "Error"
    var_w = f1_2 * random.choice(var2_2)
else:
    print("Workable code. Result:", var_r)
    var_w = False if var_r == True else True
finally:
