...
var1_1 = ["a", "b", "c"]
var1_2 = ["python", "django", "pyramid", "pythest", "variable"]
var2_1 = ["d", "e", "f"]
var2_2 = [0, 1, 2, 3]
var3 = [":", ""]
var3_1 = ["g", "h", "i"]
...
var_u_screen = f"{f1_1} = '{f1_2}'\n" \
               f"print({f1_1}[{f2_2}{f3}{f3_2}])"

var_u = f"{f1_1} = '{f1_2}'\n" \
        f"{f4_1} = {f1_1}[{f2_2}{f3}{f3_2}]\n" \
        f"var_r = {f4_1}\n" \
        f"print(var_r)"
...
try:
    ...
    var_r = "Error"
    var_w = f1_2[f2_2:f3_2]
else:
    print("Workable code. Rresult:", var_r)
    var_w = f1_2[1:4]
finally:
