...
f1_3 = random.choice(var1_3)
f2_1 = random.choice(var2)
f2_2 = random.choice(var2)
f2_3 = random.choice(var2)
f2_4 = random.choice(var2)
f3_1 = random.choice(var3)
f3_2 = random.choice(var3)
f3_3 = random.choice(var3)
...
x = [f1_1, f1_2, f1_3]
fx_1 = random.choice(x)
fx_2 = random.choice(x)

y = [fx_1, fx_2]
yx_1 = random.choice(y)
yx_2 = y[1] if yx_1 == y[0] else y[0]

z = [f2_1, f2_2, f2_3, f2_4]
...
try:
    ...
    var_r = "Error"
    var_w = random.choice(z) + random.choice(z)
else:
